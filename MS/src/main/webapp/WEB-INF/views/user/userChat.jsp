...
<body>
	...
	<div id="chatBtn2">
		<a onclick="openChat()" id="chatOpenBtn"> <img
			src="${pageContext.request.contextPath}/images/chatButton.png"
	...
	<div id="chatBox" class="chatting wow zoomIn" style="display: none">
		...
		<div id="cardbox" class="ui bg-light fluid card">
			 <div class="content">
				...
				<div>
				    ...
				    <button type="button" class="close" id="closeButton" onclick="closeChat()" aria-label="Close">
						<span aria-hidden="true"><img src="${pageContext.request.contextPath}/images/closeButton.png" style="width: 20px; height: 20px;"></span>
					</button>
				</div>
			 </div>
			...
			<div id="scrollBlind" class="scrollBlind">
			  <ol id="scrolldown" class="discussion" style="max-height: 300px;">
			    <li class="other" style='background-color: #9bbbd4;'>
			      <div class="avatar">
			        <img src="${pageContext.request.contextPath}/images/apeach.png" />
			      </div>
			    ...
			    <li class="self" style='background-color: #9bbbd4;'>
			      <div class="avatar">
			        <img src="${pageContext.request.contextPath}/images/tube.png" />
			      </div>
		    ...
		    <div>
			    ...
			    <div class="description">
			    	<div class="ui input">
			    		...
			    		<input class="ui primary button" type="image" id="sendButton" src="${pageContext.request.contextPath}/images/sendbutton.png">
			    	</div>
			    </div>
			</div>    
	...
	<script>
		...
		function addToDiscussion(writer, msg) {
			...
			var img = '${pageContext.request.contextPath}/images/tube.png';
			var backcolor = "style='background-color: #fef01b;'";
			if (writer != me) {
				img = '${pageContext.request.contextPath}/images/apeach.png';
				senders = 'other';
