...
<body>
	...
	<div class="userMain_container">
		...
		<div class="right_area">
			<table class="comTable" id="comTable">
...
<script>
	$(document).ready(function() {
		...
		$('#comTable td').click(function() {
			comObj = $(this); // 선택된 좌석의 객체를 변수 comObj에 저장
		...
		$('#add_time_btn').click(function() {
			...
			$(comObj).text(''); // 중앙에 써있던 컴퓨터 번호 지우기
			$(comObj).append(str); // 좌석 사용 정보 보여주기
			$(comObj).children().eq(0).css({ // 컴퓨터 번호 스타일 수정
