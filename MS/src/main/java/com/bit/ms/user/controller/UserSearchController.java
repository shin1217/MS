...
public class UserSearchController {
	...
	@ResponseBody
	public String userIdSearch(@RequestParam("inputEmail_1") String user_email, @RequestParam("inputPhone_1") String user_phone) {
		
		String result = searchService.get_searchId(user_email, user_phone);
